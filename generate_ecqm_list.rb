...
options = {
  ...
  output_dir: 'output',
  defaults: %w[CMS22v CMS122v CMS124v CMS125v CMS127v CMS130v CMS138v CMS147v CMS165v CMS69v], # original 10 certified measures minus version for year
  year: nil
}
...
measures.each do |m|
  seq += 10
  activity = options[:defaults].any? { |d| m[:id].start_with?(d) } ? 1 : 0
